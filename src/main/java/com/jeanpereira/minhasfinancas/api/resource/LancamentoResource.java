...
public class LancamentoResource {
	...
	public ResponseEntity buscar(
		...
		if (!usuario.isPresent()) {
			return ResponseEntity.badRequest().body("Não foi possivel realizar consulta. Usuário não encontrado.");
		}else {
	...
	private Lancamento converter(LancamentoDTO dto) {
		...
		.orElseThrow(()->
			new RegraDeNegocioExeption("Usuario não encontrado para o Id informado.")
		);
